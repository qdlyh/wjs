  ...
  <div class="content">   <!--内容白色背景-->
    <div class="section-2">
        <div class="section-2-box">
         ...
         <div class="money-btn"><a href="<?php echo U('Index/index');?>">返回首页</a> <a href="<?php echo U('Cart/gwcart');?>">点击查看购物车</a>  <a href="javascript:" onclick="window.history.go(-1)">点击返回上一页</a></div> 
   </div>
</div>
