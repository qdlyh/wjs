                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">订单模块</div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a href="<?php echo U('Order_add');?>"> 新增</a></button>
                                                <button type="button" class="am-btn am-btn-default am-btn-secondary"><span class="am-icon-save"></span><a href="<?php echo U('texcel');?>">订单导出excel</a></button>
                                    ...
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                        ...
                                        <tbody>
                                           ...
                                           <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr class="even gradeC">
                                                ...
                                                <td><?php echo ($list["order_phone"]); ?></td>
                                                <td><?php echo ($list["order_area"]); ?></td>
                                                <td><?php echo ($list["order_mess"]); ?></td>
                                                <td><?php echo (pay_state($list["order_paystate"])); ?></td>
                                                <td><?php echo (pay_type($list["order_paytype"])); ?></td>
                                                <td><?php echo ($list["order_money"]); ?></td>
                                                <td><?php echo ($list["order_media"]); ?></td>
                                                <td><?php echo ($list["order_pro"]); ?></td>
                                                <td><?php echo ($list["order_bz"]); ?></td>
                                                <td><?php echo (date("y-m-d H:i:s",$list["order_time"])); ?></td>
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="<?php echo U('order_goods',array('id'=>$list['order_id']));?>" class="tpl-table-black-operation-del">
                                                            <i class="am-icon-trash"></i> 查看商品
                                                        </a>
                                                        <a href="javascript:;">
                                                            <i class="am-icon-pencil"></i> 编辑
                                                        </a>
                                                        <a href="<?php echo U('order_del',array('id'=>$list['order_id']));?>" class="tpl-table-black-operation-del">
