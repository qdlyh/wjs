                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"><a href="<?php echo U('Class/any_add');?>"></span> 新增</button></a>
            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search" type="button"></button>
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                        ...
                                        <tbody>
                                        <?php if(is_array($any)): foreach($any as $key=>$any): ?><tr class="gradeX">
                                                <td><?php echo ($any["any_id"]); ?></td>
                                                <td><?php echo ($any["goods_num"]); ?></td>
                                                <td><?php echo ($any["any_name"]); ?></td>
                                                <td><?php echo ($any["any_num"]); ?></td>
                                                <td><?php echo ($any["any_style"]); ?></td>
                                                <td><?php echo ($any["any_admin"]); ?></td>
                                                <td><?php echo ($any["any_time"]); ?></td>
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="javascript:;">
                                                            <i class="am-icon-pencil"></i> 编辑
                                                        </a>
                                                        <a href="<?php echo U('Class/any_del',array('id'=>$any['any_id']));?>" class="tpl-table-black-operation-del">
                                ...
                                <div class="am-u-lg-12 am-cf">
                                    ...
                                    <div class="am-fr">
                                        <!--<ul class="am-pagination tpl-pagination">-->
                                            ...
                                            <li class="am-active"><?php echo ($page); ?></li>
