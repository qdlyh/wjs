                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">同一订单的商品</div>
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                        ...
                                        <tbody>
                                           ...
                                           <?php if(is_array($gd)): foreach($gd as $key=>$gd): ?><tr class="even gradeC">
                                                <td><?php echo ($gd["order_id"]); ?></td>
                                            	<td><?php echo ($gd["order_sn"]); ?></td>
                                                <td><?php echo ($gd["goods_name"]); ?></td>
                                                <td><?php echo ($gd["goods_price"]); ?></td>
                                                <td><?php echo ($gd["order_goods_num"]); ?></td>
                                                <td><?php echo (date("y-m-d H:i:s",$gd["order_goods_time"])); ?></td>
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="javascript:history.go(-1)" class="tpl-table-black-operation-del">
                                                            <i class="am-icon-trash"></i> 返回
                                                        </a>
                                                        <a href="javascript:;">
