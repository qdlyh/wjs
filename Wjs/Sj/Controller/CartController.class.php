...
class CartController extends Controller{
  ...
  public function gwcart(){
    ...
    $tool= new \Sj\Tool\AddTool();

    if(IS_GET){
      $id=I('get.id');
      $goods=M('goods')->field('goods_id,goods_name,goods_price,goods_effect,goods_img60')->find($id);   
  ...
  public function cart_del(){
    ...
    if(IS_GET){
      ...
      $this->success('删除该种商品成功','/Sj/Cart/gwcart',1);exit;
    }
