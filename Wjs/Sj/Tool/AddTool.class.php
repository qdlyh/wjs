...
abstract class ACartTool {
    ...
    * @return boolean
    */
    abstract public function add($goods_id, $goods_name, $shop_price,$goods_img60);
...
class AddTool extends ACartTool {
    ...
    */
    ...
    public function add($goods_id, $goods_name, $shop_price,$goods_img60){
        if($this->item[$goods_id]){
            $this->item[$goods_id]['num'] += 1;
        }else {
            $goods['goods_name'] = $goods_name;
            $goods['goods_price'] = $shop_price;
            $goods['goods_img60'] = $goods_img60;
            $goods['num'] = 1;
